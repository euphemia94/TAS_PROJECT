...
# Optionally you can instantiate the class and invoke the method get_description() and
...
human = Human
human.get_leg_count(Human)                     # Output: This is human
print(f"Leg count: {human.get_leg_count()}")
